...
public class TesteGridPane extends GridPane {
	...
	public TesteGridPane() {
		...
		Caixa c1 = new Caixa().comTexto("01");
		Caixa c2 = new Caixa().comTexto("02");
		Caixa c3 = new Caixa().comTexto("03");
		Caixa c4 = new Caixa().comTexto("04");
		Caixa c5 = new Caixa().comTexto("05");
		Caixa c6 = new Caixa().comTexto("06");
