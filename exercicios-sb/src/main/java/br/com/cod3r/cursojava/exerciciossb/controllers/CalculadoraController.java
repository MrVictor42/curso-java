...
public class CalculadoraController {
	...
	//localhost:8080/calculadora/subtrair?numero2=100&numero1=58
	@GetMapping("/subtrair")
	public int subtrair(@RequestParam(name="numero1") int numero1, @RequestParam(name="numero2") int numero2) {
		return numero1 - numero2;
	}
}